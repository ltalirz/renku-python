...
def test_dataset_rm(runner, client, directory_tree, subdirectory):
    ...
    assert 0 == runner.invoke(cli, ["dataset", "add", "--create", "my-dataset", directory_tree.strpath]).exit_code
...
def test_immutability_for_files(directory_tree, runner, client):
    ...
    # Add some files
    assert 0 == runner.invoke(cli, ["dataset", "add", "my-data", directory_tree.strpath]).exit_code
    ...
    # Remove some files
    assert 0 == runner.invoke(cli, ["dataset", "unlink", "my-data", "-I", "file", "--yes"]).exit_code
